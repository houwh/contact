<template>
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading employ-basic">代理信息</div>
            <div class="panel-body">
                <form class="form-horizontal" v-on:submit.prevent>
                    <!--hasta aqui-->
                    <div class="form-group">
                        <label class="col-md-3 control-label" prop="agentType">
                            <span class="text-danger">*</span>&nbsp;&nbsp;代理类型
                        </label>
                        <div class="col-md-4">
                            <select v-model="agentType" class="form-control">
                                <option value="省代理">省代理</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" prop="agentRegion">
                            <span class="text-danger">*</span>&nbsp;&nbsp;代理省份
                        </label>
                        <div class="col-md-4">
                            <select v-model="agentRegion" class="form-control">
                                <option value="北京">北京</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" prop="agentOff">
                            <span class="text-danger">*</span>&nbsp;&nbsp;代理折扣
                        </label>
                        <div class="col-md-4">
                            <select v-model="agentOff" class="form-control">
            ...
            <div class="panel-body">
                <form id="form-basic" class="form-horizontal" v-on:submit.prevent>
                    ...
                    <div class="form-group" v-show="flag==true">
                        ...
                        <div class="col-md-4">
                            <input type="text" v-model="companyBID"  class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" prop="companyBLing" :label="flagTip">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" prop="industyClass">
    ...
    export default{
        data(){
            return{
                ...
                userType:'1',
                contact:'赵琳',
                contactPhone:'13522213333',
                email:'email@d.com',
                qq:'999999',
                wechat:'wechat',
                bContact:'bcontact',
                bContactPhone:'bcontactPhone',
                industyClass:'industyClass',
                tContact:'tContact',
                tContactPhone:'tContactPhonr',
                remark:'remark',
                region:'region',
                companyName:'wwn',
                companyBID:'BID',
