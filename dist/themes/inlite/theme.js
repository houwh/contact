(function() {
    ...
    define(
        ...
        function(Rect, Convert) {
            ...
            var calc = function(targetRect, contentAreaRect, panelRect) {
                return calcByPositions(
                    ['tc-bc', 'bc-tc', 'tl-bl', 'bl-tl', 'tr-br', 'br-tr', 'cr-cl', 'cl-cr'], ['bc-tc', 'bl-tl', 'br-tr', 'cr-cl'],
                    targetRect,
                    contentAreaRect,
                    panelRect
                );
    ...
    define(
        ...
        function(Tools, Selector, Class) {
            ...
            var Collection, proto, push = Array.prototype.push,
        ...
        function(Arr, setTimeout, Tools, DomUtils, Notification) {
            return function(editor) {
                ...
                var open = function(args, closeCallback) {
                    var extendedArgs = Tools.extend(args, {
    ...
    define(
        ...
        function(document, window, DomQuery) {
            ...
            return function(id, settings) {
                var $eventOverlay, doc = settings.document || document,
                ...
                renderScroll: function() {
                    ...
                    function addScroll() {
                        function addScrollAxis(axisName, posName, sizeName, deltaPosName, ax) {
                            var scrollStart, axisId = self._id + '-scroll' + axisName,
                                prefix = self.classPrefix;
    ...
    define(
        ...
        function(document, window, DomQuery, Delay, DomUtils, Movable, Panel, Resizable) {
            ...
            function addRemove(add, ctrl) {
                var i, zIndex = FloatPanel.zIndex || 0xFFFF,
                    topModal;
    ...
    define(
        ...
        function(document, setTimeout, window, DomQuery, Env, Delay, BoxUtils, DomUtils, DragHelper, FloatPanel, Panel) {
            ...
            function handleWindowResize() {
                ...
                function reposition() {
                    var i, rect = DomUtils.getWindowSize(),
                        layoutRect;
            ...
            var Window = FloatPanel.extend({
                ...
                fullscreen: function(state) {
                    var self = this,
                        ...
                        slowRendering, prefix = self.classPrefix,
                        layoutRect;
            ...
            return Widget.extend({
                ...
                renderHtml: function() {
                    ...
                    var icon = self.state.get('icon'),
                        image, text = self.state.get('text'),
                        textHtml = '';
        ...
        function(AbsoluteLayout) {
            ...
            return AbsoluteLayout.extend({
                ...
                recalc: function(container) {
                    ...
                    var ctrl, ctrlLayoutRect, ctrlSettings, flex, maxSizeItems = [],
            ...
            var register = function(editor) {
                editor.addMenuItem('align', {
                    ...
                    menu: [{
                        text: 'Left',
                        icon: 'alignleft',
                        onclick: FormatUtils.toggleFormat(editor, 'alignleft')
                    }, {
                        text: 'Center',
                        icon: 'aligncenter',
                        onclick: FormatUtils.toggleFormat(editor, 'aligncenter')
                    }, {
                        text: 'Right',
                        icon: 'alignright',
                        onclick: FormatUtils.toggleFormat(editor, 'alignright')
                    }, {
                        text: 'Justify',
                        icon: 'alignjustify',
                        onclick: FormatUtils.toggleFormat(editor, 'alignjustify')
                    }]
                });
    ...
    define(
        ...
        function(Widget, DomUtils) {
            ...
            return Widget.extend({
                ...
                renderHtml: function() {
                    var self = this,
                        targetCtrl, forName, forId = self.settings.forId;
    ...
    define(
        ...
        function($, Control, Delay) {
            ...
            return function(elm, inline) {
                var self = this,
                    state, classPrefix = Control.classPrefix,
                    timer;
    ...
    define(
        ...
        function(Widget, DragHelper, DomUtils) {
            ...
            return Widget.extend({
                ...
                postRender: function() {
                    var self = this,
                        minValue, maxValue, screenCordName,
